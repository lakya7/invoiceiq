// reportAgent.js — Billtiq Monthly Report Agent
...
async function generateMonthlyReport({ teamId, teamName, sendEmail, adminEmail }) {
  try {
    ...
    await sendEmail({
      to: adminEmail,
      subject: `📊 Billtiq Monthly Report — ${monthName} — ${teamName}`,
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.1);max-width:600px;">
  ...
  <tr>
    <td style="padding:32px 40px;text-align:center;">
      <a href="${process.env.FRONTEND_URL || 'https://www.billtiq.app'}" style="display:inline-block;background:#e8531a;color:#ffffff;text-decoration:none;padding:15px 36px;border-radius:10px;font-weight:700;font-size:15px;">View Dashboard →</a>
    </td>
  </tr>
  ...
  <tr>
    <td style="background:#f9f9f9;padding:20px 40px;text-align:center;border-top:1px solid #f0ede8;">
      <p style="margin:0;font-size:12px;color:#9ca3af;">This report was automatically generated by Billtiq's Monthly Report Agent</p>
      <p style="margin:4px 0 0;font-size:12px;color:#9ca3af;">© 2026 Billtiq · <a href="mailto:hello@billtiq.app" style="color:#e8531a;text-decoration:none;">hello@billtiq.app</a></p>
    </td>
  </tr>
