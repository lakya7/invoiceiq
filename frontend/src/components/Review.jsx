        ...
        <div className="review-form">
          ...
          <div className="form-section">
            ...
            <div className="totals">
              <div className="total-row"><span>Subtotal</span><span>${Number(form.subtotal || 0).toFixed(2)}</span></div>
              <div className="total-row"><span>Tax</span><span>${Number(form.tax || 0).toFixed(2)}</span></div>
              <div className="total-row total-grand"><span>Total</span><span>${Number(form.total || 0).toFixed(2)}</span></div>
            </div>
          </div>
        </div>
