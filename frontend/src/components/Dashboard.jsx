    ...
    <div className="dashboard">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <div className="nav-item" onClick={onOperations}>🛠️ Operations</div>
      ...
      <main className="dash-main">
        ...
        <div className="stats-grid">
          ...
          {/* $ Pending Approval */}
          <div className="stat-card stat-clickable" style={{ cursor: "pointer", background: "white", borderColor: "var(--border)" }} onClick={() => setFilter("pending")} title="Click to filter table">
